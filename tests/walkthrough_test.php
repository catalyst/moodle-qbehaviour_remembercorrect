...
namespace qbehaviour_remembercorrect;
...
/**
 * Unit tests for the remember correct behaviour.
 *
...
final class walkthrough_test extends \qbehaviour_walkthrough_test_base {
    public function test_remembercorrect_feedback_truefalse(): void {
        // Create a true-false question with correct answer true.
        $tf = \test_question_maker::make_question('truefalse', 'true');
        $this->start_attempt_at_question($tf, 'remembercorrect', 2);
    ...
    public function test_remembercorrect_feedback_multichoice_single(): void {

        // Create a true-false question with correct answer true.
        $mc = \test_question_maker::make_a_multichoice_single_question();
        $this->start_attempt_at_question($mc, 'remembercorrect', 3);

        // Start a remember correct attempt and add the question to it.
    ...
    public function test_remembercorrect_resume_multichoice_single(): void {
        ...
        // Reinitialise.
        $this->setUp();
        $this->quba->set_preferred_behaviour('remembercorrect');
    ...
    public function test_remembercorrect_resume_multichoice_single_emptyanswer_first(): void {
