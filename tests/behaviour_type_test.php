...
/**
 * Unit tests for the remember correct behaviour type class.
 *
...
final class behaviour_type_test extends \qbehaviour_walkthrough_test_base {
    /** @var qbehaviour_remembercorrect_type */
    protected $behaviourtype;

    public function setUp(): void {
        parent::setUp();
        $this->behaviourtype = question_engine::get_behaviour_type('remembercorrect');
    }
